			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						...
						<?php echo form_open_multipart('admin/category/updateCategory', $attribute);?>						
							<div class="box-body">
							    <div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control select2" name="city_id" data-placeholder="Select City" required>
											...
											{											
											?>
											<option value="<?php echo $city_name->id; ?>" <?php if($category->city_id == $city_name->id) { ?> SELECTED <?php } ?>> <?php echo $city_name->name; ?> </option>
											<?php
											}?>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="cat_title" id="cat_title" placeholder="Enter Category Title" value="<?php echo stripslashes($category->cat_title);?>" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="cat_desc" id="cat_desc" placeholder="Enter Category Description" ><?php echo stripslashes($category->cat_desc);?></textarea>
