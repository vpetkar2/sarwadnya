    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo site_url('/admin/product');?>">Project</a></li>
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Add Feature of <?php echo $product_name;?></h3>
						</div><!-- /.box-header -->
						...
						<?php echo form_open_multipart('admin/product/submitFeature', $attribute);?>
							<div class="box-body">
								<div class="form-group">
									<label for="pf_name" class="col-sm-2 control-label">Feature Name</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="pf_name" id="pf_name" placeholder="Enter Feature Name" value="<?php echo set_value('pf_name');?>" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control"  name="pf_detail" rows="10" cols="80">
