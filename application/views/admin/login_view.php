...
<html>
  <head>
    ...
    <title>Parth Fibrotech | Administrator Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>Administrator</b>Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
		...
		<?php if($error = $this->session->flashdata('sessionlaps'))
		{?>
		<p class="login-box-msg callout callout-warning"><?php echo $error;?><BR></p>
		<?php
		}?>
        <p class="login-box-msg">Sign in to start your session</p>
        <!-- <form action="submit-login.php" method="post"> -->
		<?php echo form_open('admin/login/submit_login');?>
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="Password" name="password" id="password" value="" autocomplete="off" required>
        ...
        <a href="<?php echo site_url('/admin/forgot');?>">I forgot my password</a><br>
