...
?>
<!-------------------- new code ---------------------------------- -->
		<section class="carousel slide cid-rm0p4hgOZk" data-interval="false" id="slider2-1a" style="display: none;">
								...
								<div class="carousel-item slider-fullscreen-image<?php if($i == '0') { ?> active<?php } ?>" data-bg-video-slide="false" style="background-image: url(<?php echo $img; ?>);">
									<div class="container container-slide">
										<div class="image_wrapper">
											<div class=""></div>
											<img src="<?php echo $img; ?>" alt="<?php echo $slug[0]['cat_title']; ?>">
								...
								<div class="carousel-item slider-fullscreen-image active" data-bg-video-slide="false" style="background-image: url(<?php echo base_url('assets/site/images/background3.jpg'); ?>);">
									<div class="container container-slide">
										<div class="image_wrapper">
											...
											<img src="<?php echo base_url('assets/site/images/background3.jpg'); ?>" alt="	<?php echo $slug[0]['cat_title']; ?>">
											<div class="carousel-caption justify-content-center">
												<div class="col-10 align-center">
		...
		<section class="features19 cid-rm0pwICru2" id="features19-1d">
			<div class="container">
				<h1 class="mbr-section-title align-left mbr-bold mbr-fonts-style display-2">
				...
				<?php echo form_open_multipart('products');?>
					<input type="text" name="sch_prod" id="sch_prod" class=""/>
				...
				<?php
					...
					<?php }  }  else { ?>
						<h1 class="alert alert-warning" role="alert">Product Not found for <?php echo $slug[0]['cat_title']; ?><h1>
					<?php } ?>
