					...
					<div class="row d-flex">
						<div class="col-lg-6 col-md-12 m-b30">
							...
							<a href="javascript:void(0);"><img
									src="<?php echo base_url("assets/newsite/images/sports.jpg"); ?>"
									class="lazy radius-md m-t10"
									data-src="<?php echo base_url("assets/newsite/images/sports.jpg"); ?>" alt=""></a>

						</div>
						<div class="col-lg-6 col-md-12 m-b30 align-self-center video-infobx">
							<div class="content-bx1">
								<h2 class="m-b15 title">Sarwadnya Sports & Fitness Pvt. Ltd.
				...
				<div class="company-profile">
					...
					<table class="table table-hover table-bordered table-striped">
						<tbody>
							...
							<tr>
								...
								<td>
									<b>Sarwadnya Sports And Fitness Private Limited</b><br>
                                        Rajat Hill, Beside Lime Research Institute, <br>
                                        Amaravati Road, Nagpur - 440033, Maharashtra, India.
								</td>
							</tr>
							<tr>
								<th>Bankers</th>
							...
							<tr>
								<th>Legal Name</th>
								<td>Sanjay Ramrao Bobde</td>
							</tr>
							<tr>
								<th>Trade Name</th>
								<td>Sarwadnya Sports and Fitness Pvt. Ltd.</td>
							</tr>
							<tr>
                                <th>ICICI Bank Details</th>
                                <td>
							...
							<tr>
                                ...
                                <td>
                                    <a href="https://sarwadnyaplay.com/assets/documents/Company%20Profile.pdf" target="_blank" rel="noopener">
                            ...
                            <tr>
                                <th>SSF Playground Catalogue</th>
                                <td>
                                    <a href="https://sarwadnyaplay.com/assets/documents/SSF%20Playground%20Catalogue.pdf" target="_blank" rel="noopener">
                                        <i class="fa fa-file-pdf-o" style="color:red;"></i> View PDF
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>SSF Outdoor GYM Catalogue</th>
                                <td>
                                    <a href="https://sarwadnyaplay.com/assets/documents/SSF%20Outdoor%20GYM%20Catalogue.pdf" target="_blank" rel="noopener">
                                        <i class="fa fa-file-pdf-o" style="color:red;"></i> View PDF
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>SSF Science Park Equipment Catalogue</th>
                                <td>
                                    <a href="https://sarwadnyaplay.com/assets/documents/SSF%20Science%20Park%20Equipment%20Catalogue.pdf" target="_blank" rel="noopener">
                                        <i class="fa fa-file-pdf-o" style="color:red;"></i> View PDF
                                    </a>
                                </td>
                            </tr>
			...
			<div class="container">
				<div class="section-content">
					<div class="row d-flex">
						...
						<div class="col-lg-6 col-md-12 m-b30">
							<a href="javascript:void(0);"><img
									src="<?php echo base_url("assets/newsite/images/about-2.jpeg"); ?>"
									class="lazy radius-md m-t10"
									data-src="<?php echo base_url("assets/newsite/images/about-2.jpeg"); ?>" alt=""></a>
						</div>
					</div>
				</div>
			</div>
