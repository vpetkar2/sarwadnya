			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						...
						<?php echo form_open_multipart('admin/banner/updateBanner', $attribute);?>						
							<div class="box-body">
								<div class="form-group">
									<label for="ban_title" class="col-sm-2 control-label">Title</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="ban_title" id="ban_title" placeholder="Enter Banner Title" value="<?php echo stripslashes($banner->ban_title);?>" required>
