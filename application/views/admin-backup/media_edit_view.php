			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						...
						<?php echo form_open_multipart('admin/media/updateMedia', $attribute);?>

							<div class="box-body">
								<div class="form-group">
									<label for="media_title" class="col-sm-2 control-label">Media Title</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="media_title" id="media_title" placeholder="Enter Media Title" value="<?php echo stripslashes($media->media_title);?>" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="media_url" id="media_url" placeholder="Enter Youtube URL" required><?php echo stripslashes($media->media_url);?></textarea>
