			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						...
						<?php echo form_open_multipart('admin/carrier/submitCarrier', $attribute);?>
							<div class="box-body">
								<div class="form-group">
									<label for="crr_title" class="col-sm-2 control-label">Title</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="crr_title" id="crr_title" placeholder="Enter Carrier Title" value="<?php echo set_value('crr_title');?>" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="crr_no_of_position" id="crr_no_of_position" placeholder="Enter Carrier Title" value="<?php echo set_value('crr_no_of_position');?>" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea class="form-control" name="crr_desc" id="crr_desc" placeholder="Enter Carrier Description"><?php echo set_value('crr_desc');?></textarea>
