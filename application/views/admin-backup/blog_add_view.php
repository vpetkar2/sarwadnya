			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						...
						<?php echo form_open_multipart('admin/blog/submitBlog', $attribute);?>
							<div class="box-body">
								<!--<div class="form-group">
									...
									<div class="col-sm-10">
										<select class="form-control select2" multiple="multiple" name="cat_id[]" data-placeholder="Select Category" required>
											...
											{			
											?>
											<option value="<?php echo $category['cat_id'];?>"><?php echo stripslashes($category['cat_title']);?></option>
											<?php
											}?>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="b_title" id="b_title" placeholder="Enter Blog Title" value="<?php echo set_value('b_title');?>" required>
										<?php echo form_error('b_title', '<p class="text-danger">', '</p>')?>
									</div>
								</div>
								<div class="form-group">
									<label for="b_author" class="col-sm-2 control-label">Author</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="b_author" id="b_author" placeholder="Enter Author" value="<?php echo set_value('b_author');?>" required>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea id="editor1" name="b_desc" rows="10" cols="80"></textarea>
